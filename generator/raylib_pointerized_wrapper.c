...
Shader* LoadShader_pointerized( char * vsFileName,  char * fsFileName){
    Shader* pointer_value = malloc(sizeof(Shader));
...
long* GetFileModTime_pointerized( char * fileName){
    long* pointer_value = malloc(sizeof(long));
...
RenderTexture2D* LoadRenderTexture_pointerized(int width, int height){
    RenderTexture2D* pointer_value = malloc(sizeof(RenderTexture2D));
...
Material* LoadMaterialDefault_pointerized(){
    Material* pointer_value = malloc(sizeof(Material));
...
Music* LoadMusicStream_pointerized( char * fileName){
    Music* pointer_value = malloc(sizeof(Music));
...
AudioStream* LoadAudioStream_pointerized(int sampleRate, int sampleSize, int channels){
    AudioStream* pointer_value = malloc(sizeof(AudioStream));
