...
sub generate-bindings($raylib-raku-c-dir) is export {
    say "Generating raylib bindings...";
    my $parser = RaylibGrammar.new;
    my $actions = RaylibActions.new;
    my $raylib = slurp "$raylib-raku-c-dir/raylib.h";
    ...
    $file.say("constant LIBRAYLIB = '$raylib-raku-c-dir/libraylib.so';");
    ...
    my $wrapper_file  = open "$raylib-raku-c-dir/raylib_pointerized_wrapper.c", :w;
    ...
    my $alloc_file  = open "$raylib-raku-c-dir/raylib_allocations.c", :w;
